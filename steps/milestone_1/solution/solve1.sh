...
# Create the database setup script in the application directory
...
# Create the hello.txt file (required by milestone 1 tests)
echo "Hello, world!" > "$APP_DIR/hello.txt"

# Verify database was created
if [ -f "$APP_DIR/etl_pipeline.db" ]; then
    echo "Database setup complete: $APP_DIR/etl_pipeline.db"
fi
